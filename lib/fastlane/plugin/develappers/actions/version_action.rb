    ...
    module Actions
        class VersionAction < Action
            ...
            def self.available_options
                [
                    FastlaneCore::ConfigItem.new(key: :scheme_name, env_name: "BUILD_XCODE_SCHEME_NAME", description: "Name of scheme", type: String, optional: true),
                    FastlaneCore::ConfigItem.new(key: :info_plist_file, env_name: "VERSION_INFO_PLIST_FILE", description: "Path to info plist", type: String, optional: true),

                    FastlaneCore::ConfigItem.new(key: :output_file, env_name: "VERSION_OUTPUT_FILE", description: "File for output of version name", type: String, optional: true)
                ]
            end
